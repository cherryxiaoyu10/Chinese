...
**当前所处位置：** 开发任务完成 0/66（0%），当前位于 P0「立项与范围冻结」· 未开始。

**下一项最适合任务：** P0-01「锁定Slice A范围与规模」——负责人 producer-director；形成8–10层、2普通敌人、1精英、1首领、12–16张卡、3–4件遗物、2–3事件、2类知识的范围记录。

```mermaid
flowchart LR
    BASE[BASE 基础准备与既有产物档案\n已交付]
    P0[P0 立项与范围冻结\n未开始]
    BASE --> P0
    P1[P1 技术预研 / 垂直原型\n未开始]
    P0 --> P1
